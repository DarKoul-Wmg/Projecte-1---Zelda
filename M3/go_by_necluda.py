...
while True:
    ...
    if pregunta.lower() == 'go by the e':
        ...
        hipo_e6 = calcular_hipotenusa(locations[actual_location][playerY][playerX], E6)

        E7 = 38, 6

        hipo_e7 = calcular_hipotenusa(locations[actual_location][playerY][playerX], E7)
    ...
    if pregunta.lower() == 'go by the t':
        ...
        hipo_tree4 = calcular_hipotenusa(locations[actual_location][playerY][playerX], tree4)

        tree5 = 15, 6

        hipo_tree5 = calcular_hipotenusa(locations[actual_location][playerY][playerX], tree5)

        tree6 = 14, 7

        hipo_tree6 = calcular_hipotenusa(locations[actual_location][playerY][playerX], tree6)

        tree7 = 15, 8

        hipo_tree7 = calcular_hipotenusa(locations[actual_location][playerY][playerX], tree7)
    ...
    if pregunta.lower() == 'go by the s':
        ...
        hipo_s5 = calcular_hipotenusa(locations[actual_location][playerY][playerX], S5)

        S6 = 33, 9

        hipo_s6 = calcular_hipotenusa(locations[actual_location][playerY][playerX], S6)
    ...
    if pregunta.lower() == 'go by the water':
        ...
        hipo_w1 = calcular_hipotenusa(locations[actual_location][playerY][playerX], W1)

        W2 = 50, 5

        hipo_w2 = calcular_hipotenusa(locations[actual_location][playerY][playerX], W2)
